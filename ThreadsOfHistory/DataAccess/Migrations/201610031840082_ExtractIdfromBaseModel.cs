namespace DataAccess.Migrations
{
    ...
    public partial class ExtractIdfromBaseModel : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropPrimaryKey("dbo.Person");
            DropPrimaryKey("dbo.Event");
            AlterColumn("dbo.PersonEvent", "Event_Id", c => c.Int(nullable: false));
            AlterColumn("dbo.PersonEvent", "Person_Id", c => c.Int(nullable: false));
            AlterColumn("dbo.HistoryThread", "Id", c => c.Int(nullable: false, identity: true));
            AlterColumn("dbo.Person", "Id", c => c.Int(nullable: false, identity: true));
            AlterColumn("dbo.Event", "HistoryThread_Id", c => c.Int());
